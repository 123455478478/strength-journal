...
(async () => {
  ...
  await page.getByRole("button", { name: "重量加 2.5" }).click();
  if (await page.getByLabel("本组重量").inputValue() !== "2.5") throw new Error("重量加按钮步进错误");
  await page.getByRole("button", { name: "重量减 2.5" }).click();
